...
/*    */   
/*    */   public DependencyElementsPalette2(JTabbedPane libraryPane) {
...
/* 38 */         if (!f.getName().matches("actor.shape|actor_agent.shape|actor_position.shape|actor_role.shape|softgoal.shape")) {
