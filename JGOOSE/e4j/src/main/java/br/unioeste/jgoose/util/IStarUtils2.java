...
public class IStarUtils2 {
    ...
    public static Element createPARTICIPATES_IN() {return create(new IStarElement("actorLink", "Participates_In", "participates_in")); }
    ...
    public static Element createQuality() {return create(new IStarElement("ielement", "Quality", "Quality")); }
    ...
    public static Element createDecomposition() {return create(new IStarElement("ielementLink", "AND", "decomposition")); }
    public static Element createQualification() {return create(new IStarElement("ielementLink", "Qualification", "qualification")); }
    //TODO: add contribution values
    public static Element createDepndency() {return create(new IStarElement("dependency", "Dependency", "")); }
    public static Element createNeeded_By() {return create(new IStarElement("ielementLink", "Needed-By", "neededby")); }
    public static Element createMeansEnd() {return create(new IStarElement("ielementLink", "OR", "meansend")); }
